# Twin Rivers Council 364 dashboard help

This guide explains how to read and use the web dashboard. Open `help.html` for the styled, printable version.

## Quick start

1. Confirm the refresh date: **September 21, 2026**. The dashboard is a snapshot, not a live connection.
2. Start on Overview, then use the District control to narrow the view.
3. Use the available detail pages: Training, Districts, Unit Metrics, SYT, Coverage.
...
- **SYT Detail:** Safeguarding Youth Training detail from a visible source tab.
- **Coverage:** Commissioner people and assignments found on visible source tabs.
- **n/a:** Missing, unavailable, or not calculable; it does not mean zero.

## Data and responsible use

- Workbook: `Dashboard - Twin Rivers Council 364 - 2026-09-21.xlsx`
- Source workbook: https://1drv.ms/x/c/1234e722a6952621/IQCCHP0yVNPtQa7RPXKVnJ0xAcQC_0xeUgkwKvgKSbb_6Tc?e=ysa0L7
